	...
	var giftname=encodeURI(encodeURI(giftname1));
			...
			$(".btnn").click(function(){
				if(giftname=="" || giftname==null){
					var giftname1 = $(".giftname").val();
					var giftname=encodeURI(encodeURI(giftname1));
					window.location.href="/Yqwan/administrator/giftinfo.do?giftname="+giftname+"&page=1";
				}
			});
			...
			if(a.substring(a.lastIndexOf('=') + 1)==1){
				...
				$(".prepage").click(function(){
					...
					window.location.href="/Yqwan/administrator/giftinfo.do?giftname="+giftname+"&page="+index1;
				});
			}
			if(a.substring(a.lastIndexOf('=') + 1)==bb){
				...
				var ind1 = index1-1;
					...
					$(".nextpage").click(function(){	
						window.location.href="/Yqwan/administrator/giftinfo.do?giftname="+giftname+"&page="+index;
					});
			}
			if(bb==1){
				$(".paga .a:gt(0)").hide();
			...
			$(".paga .a").click(function(){
				var bc = $(this).text();
				window.location.href="/Yqwan/administrator/giftinfo.do?giftname="+giftname+"&page="+bc;
			});				
		});