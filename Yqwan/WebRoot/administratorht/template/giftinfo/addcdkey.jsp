				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<%=request.getContextPath()%>/administrator/cdkeyinfo.do">礼包码信息</a>
							</li>
						</ul><!-- .breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/addcdkey.do" class="form-horizontal aaaa" role="form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 礼包名 </label>
										
										<div class="col-sm-9">
											<select class="width-40 chosen-select"  name="giftid" id="form-field-select-3" data-placeholder="请选择礼包">
												<option value=""></option>
												<c:forEach items="${giftinfo}" var="gift">
									...
									<div class="form-group" style="overflow:hidden;">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 上传xls文件 </label>

										<div class="col-sm-9">
											<input type="file" name="filexls" id="id-input-file-2" style=" top:10px; display:block;" />
										</div>
									</div>	
