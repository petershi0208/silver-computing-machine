				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<%=request.getContextPath()%>/administrator/giftinfo.do">礼包信息列表</a>
							</li>
						</ul><!-- .breadcrumb -->
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<small>
								<a href="<%=request.getContextPath()%>/administrator/giftinfo.do">礼包详细信息</a>
								</small>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/updategift.do" class="form-horizontal aaaa" role="form" method="post"  enctype="multipart/form-data">
								<input type="text" style="display:none;" name="id" value="${giftinfo.id }" />
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 礼包名 </label>

										<div class="col-sm-9">
											<input type="text" name="giftname" value="${giftinfo.giftname }" id="form-field-1" placeholder="输入礼包名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<select class="width-40 chosen-select"  name="gamename" id="form-field-select-3" data-placeholder="请选择游戏">
												<option value="${giftinfo.gamename }">${giftinfo.gamename }</option>
												<c:forEach items="${gameinfos}" var="g">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 期限 </label>
										
										<div class="col-sm-9">
											<input type="text" name="timelimit" value="${giftinfo.timelimit }" id="form-field-1" placeholder="输入期限" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 礼包内容 </label>
										
										<div class="col-sm-9">
											<input type="text" name="content" value="${giftinfo.content }" id="form-field-1" placeholder="礼包内容,用逗号隔开" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 礼包类型 </label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 领取条件 </label>
										
										<div class="col-sm-9">
											<input type="text" name="conditions" value="${giftinfo.conditions }" id="form-field-1" placeholder="输入领取条件" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 激活日期 </label>
										
										<div class="col-sm-9">
											<div class="input-group" style="max-width:528px;">
												<input class="form-control date-picker" name="activationdate" value="${giftinfo.activationdate }" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" />
									...
									<div class="form-group" style="overflow:hidden;">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 发号中心图片 </label>
										<div class="col-sm-9">
											<input type="file" name="logo" id="id-input-file-1" style="top:10px; display:block;" />
										</div>
									</div>
