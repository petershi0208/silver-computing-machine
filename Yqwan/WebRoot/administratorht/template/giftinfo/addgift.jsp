					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/addgift.do" class="form-horizontal aaaa" role="form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 礼包名 </label>

										<div class="col-sm-9">
											<input type="text" name="giftname" id="form-field-1" placeholder="输入礼包名" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select"  name="gamename" id="form-field-select-3" data-placeholder="请选择游戏">
												<option value=""></option>
												<c:forEach items="${gameinfo}" var="g">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="timelimit" id="form-field-1" placeholder="输入期限" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="content" id="form-field-1" placeholder="礼包内容,用逗号隔开" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="conditions" id="form-field-1" placeholder="输入领取条件" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group" style="max-width:528px;">
												<input class="form-control date-picker col-xs-10 col-sm-5" name="activationdate" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" />
