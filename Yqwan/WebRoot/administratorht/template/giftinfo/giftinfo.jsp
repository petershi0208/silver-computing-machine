					...
					<div class="page-content">
						...
						<div class="row" id="pagi">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">礼包信息列表</h3>
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td class="hidden-480">${g.gamename }</td>
														<td>${g.timelimit }</td>
														<td class="hidden-480">
															${g.content}
														</td>
														<td>${g.type }</td>
														<td>${g.conditions }</td>
														<td>${g.activationdate }</td>
														<td><img src="/Yqwan/gamePicture/${g.logo }" /></td>
														<td>${g.date }</td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="green" href="<%=request.getContextPath()%>/administrator/singlegift.do?id=${g.id }">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red delete"  onclick="javascript:if(confirm('确定要删除此信息吗？')){alert('删除成功！');location.href='administrator/deletegift.do?id=${g.id }';return true;}return false;">
