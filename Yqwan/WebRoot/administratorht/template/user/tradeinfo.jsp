					...
					<div class="page-content">
						...
						<div class="row" id="pagi">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">充值信息列表</h3>
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<c:forEach items="${tradeinfo}" var="trade">
													<tr onClick="javascript:location.href='administrator/singlegame.do?id='+${g.id }+''">
														<td>${trade.id }</td>
														<td>${trade.userid }</td>
														<td class="hidden-480">${trade.trade_no }</td>
														<td class="hidden-480">${trade.money }</td>
														<td>${trade.gamename}</td>
														<td>${trade.gameregion}</td>
														<td>${trade.serverid}</td>
														<td>${trade.date}</td>
														<td>${trade.state}</td>
														<td>${trade.account}</td>
