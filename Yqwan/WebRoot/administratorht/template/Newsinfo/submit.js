...
//添加数据
	...
	var content2=encodeURI(encodeURI(content1));
		...
		xhr.send("title="+title+"&content="+content2+"&indexpicture="+indexpicture+"&author="+author+"&origin="+origin+"&description="+description);
	});
	//修改数据
	$(".updatebtn").click(function(){
		...
		xhr.send("id="+id+"&title="+title+"&content="+content2+"&indexpicture="+indexpicture+"&author="+author+"&origin="+origin+"&description="+description);
	});
});