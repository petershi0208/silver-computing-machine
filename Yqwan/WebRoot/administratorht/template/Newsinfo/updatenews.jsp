					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrat/fileload.do" class="form-horizontal formindexpicture" role="form" enctype="multipart/form-data">
								<input type="text" style="display:none;" class="newsid" name="id" value="${news.id}" />
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 标题 </label>

										<div class="col-sm-9">
											<input type="text" name="title" value="${news.title }" id="form-field-1 title" placeholder="输入标题" class="col-xs-10 col-sm-5 width-40 title" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select gamename" id="form-field-select-3 gamename" name="gamename" data-placeholder="请选择游戏">
												<option value="${news.gamename }">${news.gamename }</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="author" value="${news.author }" id="form-field-1 author" placeholder="输入作者" class="col-xs-10 col-sm-5 width-40 author" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="origin" value="${news.origin }" id="form-field-1 origin" placeholder="输入来源" class="col-xs-10 col-sm-5 width-40 origin" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="description" value="${news.description }" id="form-field-1 description" placeholder="输入描述" class="col-xs-10 col-sm-5 width-40 description" />
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group" style="overflow:hidden;">
										...
										<div class="col-sm-9">
											...
											<script type="text/plain" id="myEditor"  class="contte" style="height:240px;width:800px;">${news.content }</script>
										</div>
									</div>	
									<div class="form-group" style="overflow:hidden;">
