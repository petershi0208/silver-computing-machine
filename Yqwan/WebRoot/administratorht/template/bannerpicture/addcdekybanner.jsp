					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/addcdkeybanner.do" class="form-horizontal aaaa" role="form" method="post" enctype="multipart/form-data">
									...
									<div class="form-group" style="overflow:hidden;">
										...
										<div class="col-sm-9">
											<input type="file" name="picture" id="id-input-file-1" style="top:10px; display:block;" />
										</div>
									</div>	
