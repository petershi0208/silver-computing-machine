						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="<%=request.getContextPath() %>/administrator/adbanner3.do" role="button" class="green" data-toggle="modal"> 添加首页banner图 </a>
								</h4>
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<c:forEach items="${threebanner }" var="t">
													<tr onClick="javascript:location.href='+''">
														...
														<td>${t.gamename }</td>
														<td>${t.gamepicture }</td>
														<td>${t.largegamepicture }</td>
														<td>${t.bannerdate }</td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="green" href="<%=request.getContextPath()%>/administrator/singlebanner3.do?id=${t.id }">
