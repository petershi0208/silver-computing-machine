					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/addbanner3.do" class="form-horizontal aaaa" role="form" method="post" enctype="multipart/form-data">
								...
								<div class="form-group" style="overflow:hidden;">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 首页banner下开服列表图片 </label>

										<div class="col-sm-9">
											<input type="file" name="gamepicture" id="id-input-file-2" style=" top:10px; display:block;" />
										</div>
									</div> 
									
									<div class="form-group" style="overflow:hidden;">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 游戏Banner大图片 </label>

										<div class="col-sm-9">
											<input type="file" class="width-40" name="largegamepicture" id="id-input-file-5" style=" top:10px; display:block;" />
										</div>
									</div>
