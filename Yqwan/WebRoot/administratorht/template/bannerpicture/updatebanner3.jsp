					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/updatebanner3.do" class="form-horizontal aaaa" role="form" method="post"  enctype="multipart/form-data">
									<input type="text" name="id" value="${singlebanner.id}" id="form-field-1" style="display:none;" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select"  name="gamename" id="form-field-select-3" data-placeholder="请选择游戏">
												<option value="${singlebanner.gamename}">${singlebanner.gamename}</option>
								...
								<div class="form-group" style="overflow:hidden;">
										...
										<div class="col-sm-9">
											<input type="file" name="gamepicture" value="${singlebanner.gamepicture}" id="id-input-file-2" style=" top:10px; display:block;" />
										</div>
									</div> 
									
									<div class="form-group" style="overflow:hidden;">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 游戏首页大图片 </label>

										<div class="col-sm-9">
											<input type="file" name="largegamepicture" value="${singlebanner.largegamepicture}" id="id-input-file-5" style=" top:10px; display:block;" />
										</div>
									</div>	
