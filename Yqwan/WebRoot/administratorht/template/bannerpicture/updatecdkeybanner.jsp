					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/updatecdkeybanner.do" class="form-horizontal aaaa" role="form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> id </label>

										<div class="col-sm-9">
											<input type="text" name="id" value="${singlecdkeybanner.id }" id="form-field-1" class="col-xs-10 col-sm-5 width-40" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="width-40 chosen-select"  name="gamename" id="form-field-select-3" data-placeholder="请选择游戏">
												<option value="${singlecdkeybanner.gamename }">${singlecdkeybanner.gamename }</option>
									...
									<div class="form-group" style="overflow:hidden;">
										...
										<div class="col-sm-9">
											<input type="file" name="picture" value="${singlecdkeybanner.picture }" id="id-input-file-1" style="top:10px; display:block;" />
										</div>
									</div>	
