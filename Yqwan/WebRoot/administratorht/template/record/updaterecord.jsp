					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/updaterecord.do" class="form-horizontal aaaa" role="form" method="post" enctype="multipart/form-data">
									
									<input type="text" style="display: none;" value="${r.id }" name="id"/>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 专辑名 </label>

										<div class="col-sm-9">
											<input type="text" name="name" id="form-field-1 name" value="${r.name }" placeholder="输入专辑名" class="col-xs-10 col-sm-5 name" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="describe" id="form-field-1 describe" value="${r.describe }" placeholder="输入描述" class="col-xs-10 col-sm-5 describe" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="score" id="form-field-1 score" value="${r.score }" placeholder="输入评分" class="col-xs-10 col-sm-5 score" />
										</div>
									</div>
									...
									<div class="form-group" style="overflow:hidden;" style="">
										...
										<div class="col-sm-9">
											<input type="file" name="banner" value="${r.banner }" id="id-input-file-1" style="top:10px; display:block;" />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group" style="overflow:hidden;" style="">
										...
										<div class="col-sm-9">
											<input type="file" name="picture1"  value="${r.picture }" id="id-input-file-2" style="top:10px; display:block;" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 专辑名 </label>
										...
										<div class="col-sm-9" style="position: relative;">
											...
											<input type="text" class="gameid" style="width:300px;display:none;" name="gameid" value="${r.gameid }"  />
											<div class="cksj">
