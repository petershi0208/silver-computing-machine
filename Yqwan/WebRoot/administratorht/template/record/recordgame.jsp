													...
													<c:forEach items="${gameid }" var="gid">
														<c:forEach items="${gamelist }" var="g">
															...
															<tr>
																...
																<td class="hidden-480">${g.gameid }</td>
																<td>
																	${g.gametype }
																</td>
																<td class="hidden-480">
																...
																<td>
																	<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">															
																		...
																		<a class="red delete" onclick="javascript:if(confirm('确定要把此游戏从该专辑吗？')){alert('删除成功！');window.location.href='/Yqwan/administrator/deleterecordgame.do?gameid=${g.gameid }&id=${r.id }';return true;}return false;">
