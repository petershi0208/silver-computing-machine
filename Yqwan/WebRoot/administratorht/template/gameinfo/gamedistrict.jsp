						...
						<div class="row" id="pagi">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="<%=request.getContextPath()%>/administrator/adddistrict.do" role="button" class="green" data-toggle="modal"> 添加分区 </a>
								</h4>
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">游戏分区列表</h3>
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<c:forEach items="${gamedistrict }" var="gd">
													<tr>
														<td>${gd.id }</td>
														<td>${gd.gamename }</td>
														<td>${gd.gameregion}</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="green" href="<%=request.getContextPath()%>/administrator/singledistrict.do?id=${gd.id }">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red delete"  onclick="javascript:if(confirm('确定要删除此信息吗？')){alert('删除成功！');location.href='administrator/deletedistrict.do?id=${gd.id }';return true;}return false;">
