				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<%=request.getContextPath()%>/administrator/gamedistrict.do">分区信息列表</a>
							</li>
						</ul><!-- .breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="/Yqwan/administrator/adddistrict1.do" class="form-horizontal aaaa" role="form" method="post">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 区名</label>

										<div class="col-sm-9">
											<input type="text" name="gameregion" id="form-field-1" placeholder="输入区名" class="col-xs-10 col-sm-5 width-40" />
										</div>
									</div> 
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 区serverid</label>

										<div class="col-sm-9">
											<input type="text" name="serverid" id="form-field-1" placeholder="输入区serverid,新区为1，以后依次2,3,4...." class="col-xs-10 col-sm-5 width-40" />
										</div>
									</div> 
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="click" id="form-field-1" placeholder="输入点击数，占无用处" class="col-xs-10 col-sm-5 width-40" />
										</div>
									</div> 
									<div class="form-group">
