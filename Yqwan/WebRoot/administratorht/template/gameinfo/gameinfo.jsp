											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td class="hidden-480">${g.detaildescripe }</td>
														<td>
															<c:set value="${fn:split(g.picture, ',') }" var="picture" />
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="red delete" onclick="javascript:if(confirm('确定要删除此信息吗？')){alert('删除成功！');window.location.href='/Yqwan/administrator/deletegame.do?id=${g.id }&url=gameinfo';return true;}return false;">
