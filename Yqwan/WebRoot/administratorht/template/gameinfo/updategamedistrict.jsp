					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="<%=request.getContextPath()%>/administrator/updatedistrict.do" class="form-horizontal aaaa" role="form" method="post">
										<input  type="hidden" name="id" value="${district.id}" id="form-field-1" class="col-xs-10 col-sm-5 width-40" />
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 游戏名</label>

										<div class="col-sm-9">
											<input readonly="readonly" type="text" name="gamename" value="${district.gamename}" id="form-field-1" placeholder="输入游戏名" class="col-xs-10 col-sm-5 width-40" />
										</div>
									</div> 
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="gameregion" value="${district.gameregion }" id="form-field-1" placeholder="输入区名" class="col-xs-10 col-sm-5 width-40" />
										</div>
									</div> 
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="serverid" value="${district.serverid }" id="form-field-1" placeholder="输入区serverid" class="col-xs-10 col-sm-5 width-40" />
										</div>
									</div> 
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="click" value="${district.click}" id="form-field-1" placeholder="输入链接" class="col-xs-10 col-sm-5 width-40" />
										</div>
									</div> 
