...
var gamename = "宝石与爬塔";
var originalpage = "gameBSYPT";   			//对应的Yqwan的webroot根目录下的需要进入的游戏目录名称，若为手机则进入gameBSYPT/phoneLogin
...
$(function(){
	...
	$('#head_recharge').click(function(){
		...
		if(userid==''){
			...
			$('#head_recharge a').attr("href",apiUrl+"/recharge.do?gameid=60247&serverid=1");
		}
	})	
})
//跳注册页面
