...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/memberCenter/js/jquery-1.7.1.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/memberCenter/js/recharge.js"></script>
	<!-- Bootstrap -->
	...
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/memberCenter/css/recharge.css">
  </head>
  <body>
    <div id="nav">
			...
			<div class="recharge">
				<form method="post" id="form" target="_blank">
					<div class="top">
						...
						我要充值
						<span class="czjl" id="morecharge">充值记录&nbsp;&nbsp;</span>
					</div>
					<div class="zhanghu">
						<div class="cz">
							<span>请填写并确认账号</span>
					...
					<div class="chongzhi">
						...
						<div style="margin-left:200px; margin-top:30px;">
							选择充值：
							<input type="text" class="qu" placeholder="请选择游戏" id="czgame" name="gamename"/>
							<input type="text" class="subqu" placeholder="请选择分区" id="subqu" name="gameregion"/>
						...
						<span class="red wenzi">请您在游戏中建立充值到帐，以便及时到帐，谢谢！</span>
					</div>
					<div class="cztype">
						<div class="cztype1">
						...
						<div class="czmoney czyuan" id="czyuan">
							...
							<table width="500">
								...
								<tr>
									<td colspan="5">
										<span class="mred">充值兑换比例:1元=1G币 &nbsp;&nbsp;&nbsp;&nbsp;付款金额:10元,获得10G币</span>
									</td>
								</tr>
							</table>
						</div>
					...
					<div class="paytype">
						...
						<p>共计金额：<span id="showmoney">0 </span>元</p>
						<p>充值方法:</p>
						<div class="type3">
								<div class="cyber">网银充值</div>
								<div class="zhifubao">支付宝充值</div>
								<div class="shouji">手机充值</div>
							</div>
						<div class="type cybercz">
							<div class="typeinfo">
								...
								<table width="700" height="340">
									<tr>
										<td width="240"><input type="radio" name="bank" value="BJBANK"/><img src="../memberCenter/images/bank/beijingyinhang.jpg" width="153" height="33" /></td>
										<td width="240"><input type="radio" name="bank" value="CMB"/><img src="../memberCenter/images/bank/zhaioshangyinhang.jpg" width="153" height="33" /></td>
										<td width="240"><input type="radio" name="bank" value="ABC"/><img src="../memberCenter/images/bank/nonghang.jpg" width="153" height="33" /></td>
									</tr>
									<tr>
										<td><input type="radio" name="bank" value="SPDB"/><img src="../memberCenter/images/bank/fazhanpudong.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="CEBBANK"/><img src="../memberCenter/images/bank/guangdayinhang.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="GDB"/><img src="../memberCenter/images/bank/guangdongfazhan.jpg" width="153" height="33" /></td>
									</tr>
									<tr>
										<td><input type="radio" name="bank" value="CCB"/><img src="../memberCenter/images/bank/jianshe.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="CMBC"/><img src="../memberCenter/images/bank/minsheng.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="CIB"/><img src="../memberCenter/images/bank/xingye.jpg" width="153" height="33" /></td>
									</tr>
									<tr>
										<td><input type="radio" name="bank" value="NBBANK"/><img src="../memberCenter/images/bank/ningbo.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="SDB"/><img src="../memberCenter/images/bank/shenzhenfazhan.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="ICBCB2C"/><img src="../memberCenter/images/bank/nognye_76.jpg" width="153" height="33" /></td>
									</tr>
									<tr>
										<td><input type="radio" name="bank" value="CITIC"/><img src="../memberCenter/images/bank/zhognxinyinhang.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="SPABANK"/><img src="../memberCenter/images/bank/pinanyinhang.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="SHBANK"/><img src="../memberCenter/images/bank/shanghaiyinhang.jpg" width="153" height="33" /></td>
									</tr>
									<tr>
										<td><input type="radio" name="bank" value="BOCB2C"/><img src="../memberCenter/images/bank/shanghaiyinhang_39.jpg" width="153" height="33" /></td>
										<td><input type="radio" name="bank" value="PSBC-DEBIT"/><img src="../memberCenter/images/bank/zhongguoyouzheng.jpg" width="153" height="33" /></td>
						...
						<div class="type zhifubaocz">
							<div class="typeinfo">
								...
								<div class="ali"><input type="radio" name="bank" value="alipay"/><img src="../memberCenter/images/bank/Alipay.jpg" /></div>
							</div>
					...
					<p>2.充值过程中，浏览器会跳转至银行页面，支付成功后，会自动返回一起玩挂机网站，如果没有跳转或是弹出充值成功的页面，请您不要关闭充值窗口。</p>
				...
				<div class="qrjg">
							<div class="qrczjg">
								<span class="qrl">确认充值结果</span><img src='/Yqwan/memberCenter/images/xz-12.png' class="close"/>
