		...
		<div class="content_left">
			...
			<div class="tell">
				...
				<div class="tell2">
					...
					<p>解绑手机后，您将无法使用<span></span>进行找回密码及登录操作</p>
					<div>
						<div class="qr2" onclick="javascript:location.href='memberCenter/cellphone3.jsp'">下一步</div>
						<div class="qx2" onclick="javascript:location.href='secure.jsp'">取消</div>
					</div>
				</div>	
			</div>
		</div>
