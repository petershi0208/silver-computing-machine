...
<html>
  <head>
	...
	<script src="<%=request.getContextPath()%>/memberCenter/js/invitation.js" type="text/javascript"></script>
	...
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/memberCenter/css/invitation.css">
  </head>
  <body>
    <div id="nav">
				...
				<div class="center">
					...
					<div class="center_icon">
						...
						<div class="center_icon_img">
							<img src="/Yqwan/memberCenter/images/member/1-.png"/>
							<span>提交您的资料</span>
						</div>
						<img src="/Yqwan/memberCenter/images/member/lx.png" class="img1"/>
						<div class="center_icon_img02">
							<img src="/Yqwan/memberCenter/images/member/2.png"/>
							<span>申请后完成任务</span>
						</div>
						<img src="/Yqwan/memberCenter/images/member/lx.png" class="img2"/>
						<div class="center_icon_img03">
							<img src="/Yqwan/memberCenter/images/member/-----3.png"/>
							<span>获得任务赏金</span>
						</div>
					</div>
