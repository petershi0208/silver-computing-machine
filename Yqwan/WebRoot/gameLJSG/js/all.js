...
var gameurl = "http://ljsg"+apiUrl.substring(length,parseInt(length)+parseInt(9));
var gamename = "龙降三国";
var originalpage = "gameLJSG";			//对应的Yqwan的webroot根目录下的游戏目录名称
...
$(function(){
	$('.loginMag > div > a:eq(1),#head_recharge a').click(function(){
		...
		if(userid==''){
			...
			$('.loginMag > div > a:eq(1),.lori > a:eq(0),#head_recharge a').attr("href",apiUrl+"/recharge.do?gameid=xxx&serverid=1");
		}
	})	
})
