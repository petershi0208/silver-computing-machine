...
var gameurl = "http://cqsj"+apiUrl.substring(length,parseInt(length)+parseInt(9));
var gamename = "传奇世界";
var originalpage = "gameCQSJ";			//对应的Yqwan的webroot根目录下的游戏目录名称
...
$(function(){
	$('.loginMag > div > a:eq(1),#head_recharge a').click(function(){
		...
		if(userid==''){
			...
			$('.loginMag > div > a:eq(1),.lori > a:eq(0),#head_recharge a').attr("href",apiUrl+"/recharge.do?gameid=60000015&serverid=42");
		}
	})	
})
