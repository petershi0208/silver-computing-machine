...
var gamename = "兽魔奇迹";
var originalpage = "gameSMQJ";   			//对应的Yqwan的webroot根目录下的需要进入的游戏目录名称，若为手机则进入gameBSYPT/phoneLogin
...
$(function(){
	...
	$('#head_recharge').click(function(){
		...
		if(userid==''){
			...
			$('#head_recharge a').attr("href",apiUrl+"/recharge.do?gameid=60000023&serverid=1");
		}
	})	
})
