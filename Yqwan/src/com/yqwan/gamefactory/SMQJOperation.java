...
public class SMQJOperation extends Operation {
	/**
	 * 兽魔奇迹充值地址
	 */
	private static final String PAY_PATH =	"http://app1101502890.qzone.qzoneapp.com/ms/pay.php";
	/**
	 * 兽魔奇迹角色查询地址
	 */
	private static final String CHECK_PATH = "http://app1101502890.qzone.qzoneapp.com/ms/queryuser.php";
	
	/**
	 * 兽魔奇迹登录地址http://app1101502890.qzone.qzoneapp.com/ms/
	 */
	private static final String LOGIN_PATH = "http://app1101502890.qzone.qzoneapp.com/ms/login.php?";
	private static final int isAdult = 1;
	private static final String PID = "14";
	/**
	 * 兽魔奇迹秘钥
	 */
	private static final String KEY = "Q1VJxQeS7WAhGLb6";
	
	public SMQJOperation(String userid, int serverid) {
		super(userid, serverid);
	}
	public SMQJOperation() {
	}
	...
	public String payresult(String timestamp,String trade_no,String money,String ext) {
		...
		sParaTemp.put("userid",userid);
		sParaTemp.put("serverid",serverid+"");  
		sParaTemp.put("gold",Integer.parseInt(money)*100+"");
...
Log.logResult(UtilDate.getDateFormatter()+"：兽魔奇迹充值："+userid+";回调记录："+SubmitResult+"\r\n", "d:\\Logs\\PayLogs");			 		
