				...
				<div style="height:508px; width:668px;  margin:0 auto;">
					<div style="height:132px; width:666px; border:1px #bbb solid; border-radius:3px; -moz-border-radius: 3px; -webkit-border-radius: 3px;">
						...
						<div style="height:92px; width:666px;">
							...
							<div style="height:60px; width:620px; margin:0 auto; text-align:center;">
								...
								<div style="height:60px; width:117px; float:left; border-right:1px #bbb solid;">
									<ul style="list-style:none; margin-top:10px;">
										<li class="g14">已充值金额</li>
										<li class="h20">￥0.00</li>
									</ul>
								</div>
								<div style="height:60px; width:147px; float:left; border-right:1px #bbb solid;">
									<ul style="list-style:none; margin-top:10px;">
										<li class="g14">已提现金额</li>
										<li class="h20">￥0.00</li>
									</ul>
								</div>
								<div style="height:60px; width:113px; float:left;">
									<ul style="list-style:none; margin-top:10px;">
					...
					<div style="height:346px; width:666px; border:1px #bbb solid; border-radius:3px; -moz-border-radius: 3px; -webkit-border-radius: 3px;">
						<div style="height:40px; width:666px; line-height:40px; border-bottom:1px #bbb solid;">
							...
							<span class="bhp3p5">投资记录</span>
							<span>回款记录 起止日期 <input type="text" class="hg24" /> 到 <input type="text" class="hg24" /></span>
						</div>
						<div style="width:666px; height:32px; line-height:32px; background-color:#f3f3f3;">
							<ul class="ccc">
								<li class="w100">类型</li>
								<li class="w100">时间</li>
								<li class="w120">理财计划</li>
								<li class="w120">支出（元）</li>
								<li class="w120">可用余额（元）</li>
								<li class="w100">备注</li>
							</ul>
						</div>
						...
						<div style="height:50px; width:626px; margin:0 auto; background-color:#f3f3f3;">
							<div>投资次数：0次 <br />投资金额：0元</div>
						</div>
					</div>
				</div>
			</div>
