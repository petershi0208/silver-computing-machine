		...
		<div style="height:auto; width:770px;margin-top:15px; margin-left:20px; float:left; overflow:hidden;">
			<div style="height:auto; width:740px;  margin-left:20px; background-color:#FFFFFF">
				...
				<div class="qrcode" style="display:none" id="success">
					<img src="/Daqian/user/hyzx/images/oklogo.png" style="width:200px; height:200px;">
				</div>
				<img alt="pic" src="/Daqian/user/hyzx/images/wxtext.png" class="pic" id="pic"/>
			</div>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/user/hyzx/js/qrcode.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/user/hyzx/js/wxsaoma.js"></script>	
