...
<body>
<div class="pd-20">
  <form action="/Daqian/ht/creditor-add1.do" method="post" class="form form-horizontal addfrom" id="form-member-add">
  	<div style="font-size: 22px;">基本信息</div>
  	
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red"></span>姓名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text uname" value="" placeholder="请输入姓名" id="uname" name="uname" datatype="*2-16" nullmsg="姓名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text marital" value="" placeholder="请输入婚姻状况" id="marital" name="marital" datatype="" nullmsg="婚姻状况不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text idcard" value="" placeholder="请输入身份证号" id="idcard" name="idcard" datatype="" nullmsg="身份证号不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text age" value="" placeholder="请输入年龄" id="age" name="age" datatype="" nullmsg="年龄不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text phone" value="" placeholder="请输入手机" id="phone" name="phone" datatype="" nullmsg="手机不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text telephone" value="" placeholder="请输入固定电话" id="telephone" name="telephone" datatype="" nullmsg="固定电话不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text money" value="" placeholder="请输入申请金额" id="money" name="money" datatype="n" nullmsg="申请金额不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="radio" name="live" value="自建" checked="checked" />自建
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text unit_name" value="" placeholder="请输入单位名称" id="unit_name" name="unit_name" datatype="" nullmsg="单位名称不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text unit_site" value="" placeholder="请输入单位地址" id="unit_site" name="unit_site" datatype="" nullmsg="单位地址不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text unit_nature" value="" placeholder="请输入单位性质" id="unit_nature" name="unit_nature" datatype="" nullmsg="单位性质不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text unit_phone" value="" placeholder="请输入单位电话" id="unit_phone" name="unit_phone" datatype="" nullmsg="单位电话不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text position" value="" placeholder="请输入职位" id="position" name="position" datatype="" nullmsg="职位不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text education" value="" placeholder="请输入学历" id="education" name="education" datatype="" nullmsg="学历不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text wages" value="" placeholder="请输入工资收入" id="wages" name="wages" datatype="" nullmsg="工资收入不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text home_number" value="" placeholder="请输入家庭人数" id="home_number" name="home_number" datatype="" nullmsg="家庭人数不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text home_registry" value="" placeholder="请输入户籍地地址" id="home_registry" name="home_registry" datatype="" nullmsg="户籍地地址不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text home_registryid" value="" placeholder="请输入户号" id="home_registryid" name="home_registryid" datatype="" nullmsg="户号不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text address" value="" placeholder="请输入现居住地" id="address" name="address" datatype="" nullmsg="现居住地不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text wechat" value="" placeholder="请输入微信" id="wechat" name="wechat" datatype="" nullmsg="微信不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela1" value="" placeholder="请输入关系人1" id="rela1" name="rela1">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela1_name" value="" placeholder="请输入关系人1姓名" id="rela1_name" name="rela1_name">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela1_phone" value="" placeholder="请输入关系人1电话" id="rela1_phone" name="rela1_phone">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela2" value="" placeholder="请输入关系人2" id="rela2" name="rela2">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela2_name" value="" placeholder="请输入关系人2姓名" id="rela2_name" name="rela2_name">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela2_phone" value="" placeholder="请输入关系人2电话" id="rela2_phone" name="rela2_phone">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela3" value="" placeholder="请输入关系人3" id="rela3" name="rela3">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela3_name" value="" placeholder="请输入关系人3姓名" id="rela3_name" name="rela3_name">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text rela3_phone" value="" placeholder="请输入关系人3电话" id="rela3_phone" name="rela3_phone">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red"></span>关系人1姓名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text contact1_name" value="" placeholder="请输入关系人1姓名" id="contact1_name" name="contact1_name">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red"></span>关系人1电话：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text contact1_phone" value="" placeholder="请输入关系人1电话" id="contact1_phone" name="contact1_phone">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red"></span>关系人2姓名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text contact2_name" value="" placeholder="请输入关系人2姓名" id="contact2_name" name="contact2_name">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red"></span>关系人2电话：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text contact2_phone" value="" placeholder="请输入关系人2电话" id="contact2_phone" name="contact2_phone">
      </div>
      <div class="col-4"> </div>
    </div>
