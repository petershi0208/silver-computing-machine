  ...
  <form action="/Daqian/products-add.do" method="post" class="form form-horizontal" id="form-member-add">
    <div class="row cl">
      ...
      <div class="formControls col-5">
      	<select class="select" name="productname" size="1">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="请输入最小金额" id="cycle" name="cycle"  datatype="m" nullmsg="最小金额不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="请输入最大金额" id="minmoney" name="minmoney"  datatype="m" nullmsg="最大金额不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" style="width:205px;" class="input-text" value="" placeholder="请输入年回报率" id="maxmoney" name="maxmoney"  datatype="m" nullmsg="年回报率不能为空">
        <span>%</span>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" style="width:205px;" class="input-text" placeholder="请输入到期回报率" name="lastmoney" id="lastmoney" datatype="e" nullmsg="到期回报率不能为空！">
      	<span>%</span>
      </div>
      <div class="col-4"> </div>
    </div>
