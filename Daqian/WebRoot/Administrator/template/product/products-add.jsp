...
<body>
<div class="pd-20">
  <form action="/Daqian/addproducts.do" method="post" class="form form-horizontal addfrom" id="form-member-add">

    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>产品名：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text isproduct" value="" placeholder="请输入产品名" id="productname" name="productname" datatype="*2-16" nullmsg="产品名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-1">
        <input type="text" class="input-text" value="" placeholder="请输入金额" id="money" name="money"  datatype="n" nullmsg="金额不能为空">
      </div>
      <div class="col-4"style="font-size:20px;">元</div>
    </div>
     <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>年化回报率：</label>
      <div class="formControls col-1">
        <input type="text" class="input-text" value="" placeholder="年化回报率" id="yearreturn" name="yearreturn"  datatype="n" nullmsg="年化回报率">
      </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-1">
        <input type="text" class="input-text" value="" placeholder="到期回报率" id="duereturn" name="duereturn"  datatype="n" nullmsg="到期回报率">
      </div>
      <div class="col-4" style="font-size:20px;">%</div>
    </div>
    <div class="row cl">
