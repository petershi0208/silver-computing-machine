	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				<td class="id">${l.id }</td>
				<td >${l.username }</td>
				<td class="ppname">${l.type }</td>
				<td class="aamount">${l.logindate }</td>
				<td>
					<a href="/Daqian/admindel.do?id=${l.id }">删除</a>
					<a href="/Daqian/adminsingle.do?id=${l.id }">修改</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
