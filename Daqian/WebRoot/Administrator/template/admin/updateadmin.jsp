...
<div class="pd-20">
  <form action="/Daqian/updateadminpwd.do" method="post" class="form form-horizontal updateform" id="form-member-add">
    <input type="text" class="adminid" name="adminid" value="${adminid }" style="display: none;">
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>密码：</label>
      <div class="formControls col-5">
        <input type="password" class="input-text password" value="" placeholder="请输入密码" id="password" name="password" datatype="*" nullmsg="密码格式错误">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="password" class="input-text repwd" value="" placeholder="确认密码" id="repwd" name="repwd" datatype="*" nullmsg="两次密码不一致">
   ...
   <div class="row cl">
    ...
    <div class="row cl">
      <div class="col-9 col-offset-3">
        <input class="btn btn-primary radius updatebtn" type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
      </div>
    </div>
  </form>
