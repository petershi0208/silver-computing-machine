	...
	<div class="pd-20 form form-horizontal">
		...
		<div class="row cl" >
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="" id="tt" name="title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				...
				<input type="button" value="上传" onclick="changeform(this)"/><span id="imgg">请添加图片</span>             
				</form>  
		...
		<div class="row cl">
			<div class="col-10 col-offset-2">
				<button onClick="getContent();" class="btn btn-primary radius aaa" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>
